...
const PlatformPickerModel = ({ connectedIds, connecting, onClose, onConnect }: PlatformPickerModalProps) => {
  return (
            ...
            {PLATFORMS.map((p)=>{
                ...
                return (
                    <button 
                        ...
                        className={`flex items-center gap-4 w-full text-left rounded-lg px-4 py-3 border ${isConnected ? "border-red-300 bg-red-50 cursor-not-allowed" : "border-slate-200 hover:bg-slate-50"} transition-colors`}
                    >
                        {/* Icon */}
                        <div className="p-2">
