      ...
      {activeScheduler && (
        <div className="fixed inset-0 min-h-screen z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            {/* Corrected Schedule Section */}
            <div className="px-8 py-6 border-t border-slate-100 bg-white flex flex-col gap-6">
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 rounded-lg border transition-all ${
                          active
                            ? "bg-[#fd5c63] text-white border-transparent"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <input
                    type="date"
                    className="w-full pl-11 pr-4 py-3 bg-[#f8fafc] border border-slate-50 text-slate-700 text-sm focus:outline-none focus:ring-1 focus:ring-slate-200 rounded-xl transition-all"
                    value={scheduledDate}
              ...
              {/* <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl bg-[#eef2f6] text-[#475569] font-medium hover:bg-[#e2e8f0] transition-colors"
              >
                {scheduling ? (
                  <Loader2Icon className="size-4 animate-spin" />
                ) : (
