...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      {/* Stat cards grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-6"> {/* Updated lg:grid-cols-4 to lg:grid-cols-3 since you only have 3 cards */}
        {statCards.map((card) => {
          const Icon = card.icon; // Extract the icon component dynamically
          return (
            <div key={card.label} className="bg-white hover:bg-slate-50 relative border border-slate-200 rounded-2xl p-5 transition-all">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-xs absolute right-4 top-4 text-emerald-500 flex items-center gap-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                <Icon className="size-4 text-slate-400" /> {/* Render the icon */}
